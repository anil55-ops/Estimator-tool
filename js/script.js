      ...
      setTimeout(function () {
        ...
        jQuery.ajax({
          ...
          success: function (data) {
            ...
            jQuery("#SuccessResponseModal").css("display", "flex");
            jQuery(".SuccessModalClose").click(function () {
              location.reload();
            });
          },
        ...
        jQuery(".msg").text(
          "Your estimate will be emailed to you shortly! If you don't see it, please check your junk folder."
        );
        video.pause();
      }, dynamic_duration * 1000); // 30000ms = 30 seconds
    }
  });
